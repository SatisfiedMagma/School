...
\end{ans}
\begin{question}
      Why Mahatma Gandhi withdraw ``Civil Disobedience Movement''?
\end{question}
\begin{ans}
      Mahatma Gandhi withdrew the movement due to the 
      following reasons
      \begin{itemize}
            \item He was getting worried about the development
                  of the movement in certain places and thought 
                  the movement might go violent.
            \item When Abdul Ghaffar Khan(a follower of Gandhi ji) 
                  got arrested, the movement started to go 
                  wild and violent. People came to streets 
                  and started protestations. Police responded 
                  with heavy repression where they fired at 
                  innocent people and several people died.
            \item When Gandhi ji himself got arrested around 
                  a month later after Ghaffar Khan, people 
                  went insane in \emph{Sholapur}. They started 
                  attacking Police Chowkis, Law Courts, 
                  government buildings, basically everything 
                  which symbolized the \emph{British Rule}.
            \item All \emph{satyagrahi's} were brutally
                  attacked. Small children and women were 
                  beaten up. Around 1 lakh people were arrested.
            \item Gandhi ji thought to hold the movement for 
                  now and came into a pact with Lord Irwin. 
                  According to the pact, the movement will be 
                  stopped and Gandhi ji would attend the 2\textsuperscript{nd}
...
\begin{ans}
      Some reasons are: 
      \begin{itemize}
            \item Gandhi ji thought that the movement was 
                  turning violent in some places. Satyagrahis 
                  need to trained properly before participating 
                  in mass struggles. 
            \item Absence of institutions was slowing down the 
                  movement as people started to roll back in 
                  schools, offices, and government bodies 
                  due to lack of alternatives.
            \item The immediate cause of withdrawal was the 
                  \emph{``Chauri-Chaura''} incident where 
                  22 policemen were bolted in the Chowki. The 
                  chowki was lit on fire which took the lives 
                  of police officers.
            \item The Congress was tired of mass struggles and wanted to participate in elections of the provincial council that have been set up by the Government of India Act 1919.
            \item They felt that it was important to oppose British policies within the council, argue for reforms and demonstrate that these councils were not truly democratic.
      \end{itemize}
\end{ans}
\end{document}
